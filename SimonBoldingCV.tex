...
\item[] \ressubheading{Texas A\&M University\vspace{0.05in}}{College Station, TX}{Ph.D. Nuclear Engineering}{2013--Current}
	...
	\begin{itemize}
		...
		\resitem{\textbf{Department of Energy Nuclear Energy University Program Fellowship}, 3 years}
...
\resitem{GPA: 4.0, Advisor: Ken Shultis}
	...
	\begin{itemize}
	           \resitem{Graduated Summe Cum Laude with physics minor and nuclear engineering option}
		\resitem{GPA: 4.0}
	\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{center}\begin{tabular*}{6.6in}{l@{\extracolsep{\fill}}r}
        ...
        \multicolumn{2}{c}{ANS Graduate Scholarship (\$3 000) \cftdotfill{\cftdotsep} 2011, 2012}\\
...
\ressubheading{Los Alamos National Laboratory: CCS-2}{Los Alamos, NM}{Graduate Intern}{Summer 2014}
	...
	\resitem{Developed methodology for thermal radiation physics, implemented non-linear solution method, and learned \textbf{C++ templates} and software development tools such as CMake and simple XML parsing}
	\resitem{Work resulted in M\&C conference paper, submitted for 2015}
	\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\resheading{Publications and Conference Presentations}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
